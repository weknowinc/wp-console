...
namespace WP\Console\Core\Site;

use WP\Console\Component\Utility\Crypt;
...
final class Settings {
     ...
     * Singleton instance.
     *
     * @var \WP\Console\Core\Site\Settings
     */
     ...
     * then if the caller does not provide a $site_path only the Wordpress root will
